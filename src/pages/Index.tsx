...
Mensaje: ${formData.message}`;
  ...
  const navigationItems = [
    ...
    { href: "#buenas-practicas", label: "Buenas Prácticas CAA" },
    { href: "#faq", label: "FAQ" },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <a
        href="https://wa.me/56998206450"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg caa-transition animate-float"
      >
            ...
            <nav className="hidden lg:flex items-center space-x-6">
              {navigationItems.map((item) => (
                <a
                  key={item.href}
                  href={item.href}
                  className="text-sm font-medium text-foreground hover:text-primary caa-transition"
                >
                  {item.label}
                </a>
              ))}
              ...
              <nav className="flex flex-col space-y-2">
                {navigationItems.map((item) => (
                  <a
                    key={item.href}
                    href={item.href}
                    className="py-2 px-4 text-sm font-medium text-foreground hover:text-primary hover:bg-muted rounded-md caa-transition"
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Es docente de la Universidad del Desarrollo (UDD) donde dirige un diplomado en CAA, es miembro del Comité académico de ISAAC (Asociación Internacional de CAA) y forma parte del equipo profesional del Centro de Rehabilitación Amancay.
                </p>
              ...
              <div className="relative">
                <img
                  src={claudiaMarimon}
                  alt="Claudia Marimón"
                  className="rounded-2xl caa-shadow-card w-full"
                />
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <Card key={index} className="group hover:shadow-lg caa-transition caa-shadow-card">
                  <CardHeader>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-12">
              <img
                src={groupTherapy}
                alt="Programas de capacitación grupal"
                className="rounded-2xl caa-shadow-card w-full max-w-4xl mx-auto"
              />
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <Card key={index} className="text-center p-6 hover:shadow-lg caa-transition caa-shadow-card">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqData.map((faq, index) => (
                <AccordionItem 
                  key={index} 
                  value={`item-${index}`} 
                  className="bg-background rounded-lg px-6 caa-shadow-card"
                >
                ...
                <ul className="space-y-2">
                  {navigationItems.slice(0, 4).map((item) => (
                    <li key={item.href}>
                      <a 
                        href={item.href} 
                        className="text-background/70 hover:text-background caa-transition"
                      >
                        {item.label}
                      </a>
                    </li>
